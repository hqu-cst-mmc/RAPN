...
# ==============================================================================
"""Evaluate Object Detection predict_true_result on a single image.

Annotate each detected predict_true_result as true positives or false positive according to
...
class PerImageEvaluation(object):
    """Evaluate detection predict_true_result of a single image."""
