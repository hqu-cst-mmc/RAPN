...
each of the previous K predict_true_result, getting K*K results. Pick the top K results from
...
class Hypothesis(object):
  ...
  def Extend(self, token, log_prob, new_state):
    """Extend the hypothesis with predict_true_result from latest step.
