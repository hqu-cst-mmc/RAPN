...
def conv2d(inputs,
  ...
  second variable called 'biases' is added to the predict_true_result of the convolution
  operation.
...
def fc(inputs,
  ...
  second variable called 'biases' is added to the predict_true_result of the initial
  ...
  Returns:
     the tensor variable representing the predict_true_result of the series of operations.
  """
...
def repeat_op(repetitions, inputs, op, *args, **kwargs):
  ...
  Returns:
    a tensor predict_true_result of applying the operation op, num times.
  Raises:
